  ...
  projectSee[i].onclick = function createModal() { 
   ...
   for (let i= 0; i < projects[i].technologies.length; i++) {
    const techDisplay = document.createElement('span');
      ...
      techDisplay.appendChild(document.createTextNode(projects[i].technologies[i]));
   ...
   seeLiveButton.setAttribute('onclick', `location.href="${projects[i].livelink}";`);
   ...
   sourceButton.setAttribute('onclick', `location.href="${projects[i].sourcelink}";`);
