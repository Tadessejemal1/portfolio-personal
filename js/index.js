...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const cardDetails = [
    ...
    },
    {
      id: 3,
      title: 'ToDo List App',
      desc: 'This project is a user add the lists of the tasks, and the website has a features of editing , delete and store the data to local storage using webpack to structure To-do-list app. It is a minimal implementation of a To Do list.',
      languages: ['HTML', 'CSS', 'JavaScript'],
      live: 'https://tadessejemal1.github.io/To-Do-list-Web/dist/',
      source: 'https://github.com/Tadessejemal1/To-Do-list-Web.git',
      img: './images/Capture-t.JPG',
    },
    {
      id: 4,
    ...
    },
    {
      ...
      img: './images/Capture-l.JPG',
    },
    {
      id: 6,
      title: 'Bookstore CMS',
      desc: 'Bookstore is a website to manage collection of books. It is a Single Page App (SPA) that allows users to: Display a list of books., Add a book. , and Remove a selected book..',
      languages: ['React JS', 'React Router Dom'],
      live: 'https://develop--lucent-pony-e269a9.netlify.app/',
      source: 'https://github.com/Tadessejemal1/Bookstore.git',
      img: './images/Capture-bn.JPG',
    },
    {
      id: 7,
